      ...
      <View style={styles.innerWrapper}>
        <View style={styles.header}>
          <View style={{ minWidth: 180 }}>
            ...
            <Text style={[styles.headerTitle, isSmallMobile && { fontSize: 20 }]}>Mapa de Red</Text>
          </View>
          <View style={styles.headerActions}>
            {(selectedBuilding || selectedDevice) && (
              ...
              >
                <Feather name="maximize-2" size={12} color="#0A84FF" />
            ...
            <View style={styles.counterBadge}>
              <Feather name="map-pin" size={12} color="#0A84FF" />
...
const styles = StyleSheet.create({
  ...
  mainLayoutTablet: { flexDirection: 'row', paddingHorizontal: 16 },
  mapContainer: { flex: 1, borderRadius: 16, overflow: 'hidden', minHeight: 300, marginBottom: 10 },
